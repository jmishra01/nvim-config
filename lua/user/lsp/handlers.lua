...
local function lsp_keymaps(bufnr)
  ...
  buf_set_keymap("<leader>f", "<cmd>lua vim.diagnostic.open_float()<CR>", opts)
  buf_set_keymap("[d", '<cmd>lua vim.diagnostic.goto_prev({ border = "rounded" })<CR>', opts)
  buf_set_keymap("gl", '<cmd>lua vim.lsp.diagnostic.show_line_diagnostics({ border = "rounded" })<CR>', opts)
  buf_set_keymap("]d", '<cmd>lua vim.diagnostic.goto_next({ border = "rounded" })<CR>', opts)
  buf_set_keymap("<leader>q", "<cmd>lua vim.diagnostic.setloclist()<CR>", opts)
